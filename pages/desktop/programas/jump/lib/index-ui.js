...
new P5(p5 => {
  ...
  p5.setup = () => {
    const { canvas } = config
    const buttons = {
      cleanSlate: createElement('button', { class: 'btn', title: 'Comece treinando a IA do zero.' }, 'IA do zero'),
      preEvolved: createElement('button', { class: 'btn', title: 'Comece com uma IA já treinada.' }, 'IA já treinada')
    }
